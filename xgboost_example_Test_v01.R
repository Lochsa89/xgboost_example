...
setwd("/Users/thoffman/Documents/Activation_Prediction")
...
base_data=read.csv("/Users/thoffman/Downloads/ActPredExtractv01_2018-2-15_1117.csv",header=TRUE)
...
#Define label names
labels_train <- train$activated
labels_test <- test$activated


#Create new training and test set, with one hot encoding
